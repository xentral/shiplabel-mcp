...
keys a carrier expects at runtime.
...
| **DPD** | Your DPD sales contact | Needs partner name/token + cloud user id/token from DPD. |
| **UPS** | [developer.ups.com](https://developer.ups.com) | OAuth client credentials + your UPS account number; sandbox available. |
| **FedEx** | [developer.fedex.com](https://developer.fedex.com) | OAuth client credentials + account number; sandbox available. |
| **GLS** | Your GLS sales contact | Username/password + customer/contact id. |
| **Sendcloud** | [sendcloud.com](https://www.sendcloud.com) | Self-serve API public/secret key + a shipping-method id. Aggregates PostNL, Swiss Post, Österr. Post, DPD, DHL and more. |
